...
class File {
    ...
    public static function upload($inputfile, $pathfile, $extensions = array(), $namefile = ''){
    ...
    public static function update($inputfile, $pathfile, $filenow, $extensions = array(), $namefile = ''){

        // ** verifica se algum arquivo está sendo enviado pelo servidor
        if( empty(file_name($inputfile)) ){

            // ** caso nenhum arquivo foi enviado o nome do arquivo atual é retornado
            return $filenow;
        }
    ...
    public static function delete($caminho, $file){

        if( file_exists($caminho . $file) ){
            return file_delete($caminho . $file);
        }
